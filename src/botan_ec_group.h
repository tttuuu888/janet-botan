...
static void ec_group_tostring_fn(void *p, JanetBuffer *buffer);
...
/* Janet functions */
static Janet ec_group_to_string(int32_t argc, Janet *argv);
static Janet ec_group_to_name(int32_t argc, Janet *argv);
...
static JanetMethod ec_group_methods[] = {
    ...
    {"to-string", ec_group_to_string},
    {"to-name", ec_group_to_name},
    {NULL, NULL},
};
...
static void ec_group_tostring_fn(void *p, JanetBuffer *buffer) {
    botan_ec_group_obj_t *obj = (botan_ec_group_obj_t *)p;
    botan_ec_group_t ec_group = obj->ec_group;

    /* view_data_t str; */
    /* int ret = botan_ec_group_view_string(ec_group, &str, (botan_view_str_fn)view_str_func); */
    /* JANET_BOTAN_ASSERT(ret); */

    /* view_data_t name; */
    /* ret = botan_ec_group_view_name(ec_group, &name, (botan_view_str_fn)view_str_func); */
    /* JANET_BOTAN_ASSERT(ret); */
...
static Janet ec_group_to_string(int32_t argc, Janet *argv) {
    ...
    /* view_data_t data; */
    /* int ret = botan_ec_group_view_string(ec_group, &data, (botan_view_str_fn)view_str_func); */
    /* JANET_BOTAN_ASSERT(ret); */
...
static Janet ec_group_to_name(int32_t argc, Janet *argv) {
    ...
    /* view_data_t data; */
    /* int ret = botan_ec_group_view_name(ec_group, &data, (botan_view_str_fn)view_str_func); */
    /* JANET_BOTAN_ASSERT(ret); */
...
static JanetReg ec_group_cfuns[] = {
    ...
    {"ec-group/to-name", ec_group_to_name,
     "(ec-group/to-name ec-group-obj)\n\n"
     "Returns the EC Group as a name if it has one, otherwise as dot notation."
    },
    {NULL, NULL, NULL}
};
