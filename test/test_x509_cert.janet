...
(let [cert-not-before 1711871124
  ...
  (assert (:allow-usage cert1 "NO-CONSTRAINTS"))
  (assert (:allow-usage cert1 "DIGITAL-SIGNATURE"))
  (assert (:allow-usage cert1 "NON-REPUDIATION"))
  (assert (:allow-usage cert1 "KEY-ENCIPHERMENT"))
  (assert (:allow-usage cert1 "DATA-ENCIPHERMENT"))
  (assert (:allow-usage cert1 "KEY-AGREEMENT"))
  (assert (:allow-usage cert1 "KEY-CERT-SIGN"))
  (assert (:allow-usage cert1 "CRL-SIGN"))
  (assert (:allow-usage cert1 "ENCIPHER-ONLY"))
  (assert (:allow-usage cert1 "DECIPHER-ONLY")))
